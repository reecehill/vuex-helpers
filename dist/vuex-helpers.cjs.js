 ...
 */
function mapInstanceState(getNamespace, mappers) {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
function mapInstanceGetters(getNamespace, mappers) {
    if (Array.isArray(mappers)) {
        return mappers.reduce((acc, name) => Object.assign(acc, {
            // Note: Do not use an arrow function as we need to capture `this` at runtime
            [name]() {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
function mapInstanceMutations(getNamespace, mutations) {
 ...
 * @returns {Object}          instance-aware state computed property methods
 */
function mapInstanceActions(getNamespace, actions) {
...
exports.mapInstanceActions = mapInstanceActions;
exports.mapInstanceGetters = mapInstanceGetters;
exports.mapInstanceMutations = mapInstanceMutations;
exports.mapInstanceState = mapInstanceState;
